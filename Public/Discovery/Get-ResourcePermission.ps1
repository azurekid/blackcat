function Get-ResourcePermission {
    ...
    .DESCRIPTION
Tests the current user's effective write and action permissions across Azure subscriptions and resources by probing operations and capturing authorization responses.
